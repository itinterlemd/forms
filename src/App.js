...
class App extends Component {
    ...
    constructor() {
        ...
        this.onRenderRoute = this.onRenderRoute.bind(this);
        this.createMenu();
    }

    onRenderRoute(props) {
       return  this.props.location.pathname !=='/contactos';
    }
    ...
    createMenu() {
        this.menu = [
            {label: 'Principal', icon: 'pi pi-fw pi-home', command: () => {window.location = '#/'}},
            
            {
                label: 'Páginas', icon: 'pi pi-fw pi-globe', badge: '3',
                items: [
                    {label: 'Contactos', icon: 'pi pi-fw pi-calendar', command: () => {window.location = '#/contactos'}},
    ...
    render() {
        ...
        return (
            <div className={wrapperClass} onClick={this.onWrapperClick}>
                <AppTopbar onToggleMenu={this.onToggleMenu} showToggleMenu={this.onRenderRoute(this.props)}/>
