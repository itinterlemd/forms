...
export class Layout extends Component {
    ...
    constructor() {
        super();
        this.state = {
            layoutMode: 'static', //static overlay
            layoutColorMode: 'light',//dark light
    ...
    onSidebarClick(event) {
        this.menuClick = true;
        if(this.layoutMenuScroller.moveBar()){
    ...
    createMenu() {
        this.menu = [
            ...
            {
                label: 'Contactos', icon: 'pi pi-fw pi-users',
                items: [
                    {label: 'Consultar', icon: 'pi pi-fw pi-search', to: '/v1/contactos'}
                ]
            },
            {
